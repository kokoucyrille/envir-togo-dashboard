...
<style>
    ...
    /* Le dossier pages/ est detecte automatiquement par Streamlit comme systeme
       de navigation multi-pages natif. L'application utilise son propre menu
       (menu radio personnalise) pour router l'affichage : la navigation native
       generee automatiquement est donc masquee pour eviter tout doublon. */
